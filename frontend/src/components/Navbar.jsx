    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-[#2a5214] shadow-md py-4 px-8 flex justify-between items-center">
      ...
      <nav>
        <ul className="flex space-x-6 text-[#ffffff] font-medium">
          <li>
            <Link to="/" className="hover:text-[#c2ff94] transition">
              Home
            </Link>
          </li>
          <li>
            <Link to="/login" className="hover:text-[#c2ff94] transition">
              Login
            </Link>
          </li>
          <li>
            <Link to="/register" className="hover:text-[#c2ff94] transition">
              Register
            </Link>
          </li>
        </ul>
